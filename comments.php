...
<div id="respond-wrapper">
	<div id="respond">
		...
		<p><?php printf(__('You have to be <a href="%s">logged in</a>.','scapegoat'), wp_login_url( get_permalink() )); ?></p>
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<p><?php printf(__('Logged in as <a href="%1$s">%2$s</a>.','scapegoat'), get_option('siteurl') . '/wp-admin/profile.php', $user_identity); ?> <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php _e('Log out of this account'); ?>"><?php _e('Log out','scapegoat'); ?> &raquo;</a></p>
